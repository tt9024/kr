...
namespace utils {
    ...
    public:
        ...
        private:
            const volatile CircularBuffer<QLen, MwQueue::HeaderLen>* const m_buffer;
        ...
        private:
            volatile CircularBuffer<QLen, MwQueue::HeaderLen>* const m_buffer;
    ...
    template<int QLen>
    inline
    QStatus MwQueue<QLen>::Reader::seekToEnd() {
        m_pos = *m_ready_bytes;
    }
